...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('ntrip_server', default_value='YOUR_NTRIP_SERVER'),
        DeclareLaunchArgument('ntrip_port', default_value='8002'),
        DeclareLaunchArgument('ntrip_username', default_value='YOUR_NTRIP_USERNAME'),
        DeclareLaunchArgument('ntrip_password', default_value='YOUR_NTRIP_PASSWORD'),
        DeclareLaunchArgument('ntrip_mountpoint', default_value='YOUR_NTRIP_MOUNTPOINT'),
        Node(
